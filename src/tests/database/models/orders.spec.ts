...
import MIG_PARTNER from '../../../database/migrations/20260331092041-create_table_partners.ts'
import MIG_PRODUCT from '../../../database/migrations/20260331093945-create_table_products.ts'
import MIG_ORDER from '../../../database/migrations/20260331101858-create_table_orders.ts'
import { 
  sequelize, 
  IUser, 
  IPartner, 
  ...
  IConsignmentDetail,
  IConsignmentSold, 
IConsignmentPayed} from '../../../database/models/db.ts';
import { UserRole } from '../../../database/models/user.ts';
import { PaymentMethod } from '../../../database/models/order.ts';

const fakeProductCategories = ['hello', 'yooo', 'zzzzzz'];

var fakeUser:IUser;
var fakePartner:IPartner;
var fakeProducts:IProduct[];
var fakeOrder:IConsigment;

let fakeAmmount:number = 0;
